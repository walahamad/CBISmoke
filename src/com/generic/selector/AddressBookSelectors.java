...
public class AddressBookSelectors {
	//done
	public static final String saveAddress = "addAddressdetails";
	public static final String defaultAddress = "defaultAddress";
	public static final String editAddress = "edit-address";
	public static final String addressDetail = "address-info-listing";
	public static final String addNewAddress = "btnAddAddressPopup";
