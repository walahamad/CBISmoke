...
public class SearchResults extends SelTestCase {
    ...
    public static void compareAppliedFilterWithDisplayedProductNumber(String filterName) throws Exception {
		...
		if (filterName.equals("stores")) {
			tempAppliedFilterCount = SearchResults.getFacetNavTitleStoresCount();
		} else if (filterName.equals("price")) {
			tempAppliedFilterCount = SearchResults.getFacetNavTitlePriceCount();
		} else if (filterName.equals("colour")) {
			tempAppliedFilterCount = SearchResults.getFacetNavTitleColourCount();
		} else if (filterName.equals("size")) {
			tempAppliedFilterCount = SearchResults.getFacetNavTitleSizeCount();
		}
		...
		String displayedProductsCount = SearchResults.getNumberOfproducts().trim();
