...
private static void clickLogin() throws InterruptedException, IOException {
	getCurrentFunctionName(true);
...
private static void typePassword(String password) throws InterruptedException, IOException {
	getCurrentFunctionName(true);
...
private static void typeUsername(String userName) throws InterruptedException, IOException {
	getCurrentFunctionName(true);
